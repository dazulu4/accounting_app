...
class TaskValidationMessages:
    ...
    TITLE_TOO_SHORT: Final[str] = f"Task title must be at least {TaskConstants.TITLE_MIN_LENGTH} character long"
    TITLE_TOO_LONG: Final[str] = f"Task title cannot exceed {TaskConstants.TITLE_MAX_LENGTH} characters"
    
    # Description validation messages  
    DESCRIPTION_REQUIRED: Final[str] = "Task description is required"
    DESCRIPTION_TOO_SHORT: Final[str] = f"Task description must be at least {TaskConstants.DESCRIPTION_MIN_LENGTH} character long"
    DESCRIPTION_TOO_LONG: Final[str] = f"Task description cannot exceed {TaskConstants.DESCRIPTION_MAX_LENGTH} characters"
    ...
    MAX_TASKS_EXCEEDED: Final[str] = f"User cannot have more than {TaskConstants.MAX_TASKS_PER_USER} active tasks"
