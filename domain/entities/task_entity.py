...
class TaskEntity:
    ...
    def update_title(self, new_title: str) -> None:
        ...
        """
        if self.status.is_terminal():
            raise TaskAlreadyCompletedException("Cannot update completed or cancelled task")
    ...
    def change_priority(self, new_priority: TaskPriorityEnum) -> None:
        ...
        """
        if self.status.is_terminal():
            raise TaskAlreadyCompletedException("Cannot change priority of completed or cancelled task")
    ...
    def is_overdue(self, days_threshold: int = TaskConstants.TASK_COMPLETION_TIMEOUT_DAYS) -> bool:
        """
