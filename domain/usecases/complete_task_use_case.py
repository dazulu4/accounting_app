...
from domain.entities.task_entity import TaskEntity, TaskStateTransitionException, TaskAlreadyCompletedException
...
class CompleteTaskUseCase:
    ...
    def execute(self, command: CompleteTaskRequest) -> CompleteTaskResponse:
        ...
        except (TaskNotFoundException, TaskAlreadyCompletedException, TaskStateTransitionException) as e:
            self._logger.error(
