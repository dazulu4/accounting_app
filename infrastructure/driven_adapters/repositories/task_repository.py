...
class TaskModel(Base):
    ...
    task_id: Mapped[UUID] = mapped_column(
        primary_key=True, name=TaskDatabaseConstants.TASK_ID_COLUMN
    )

    # Required fields
    title: Mapped[str] = mapped_column(
        String(200), nullable=False, name=TaskDatabaseConstants.TITLE_COLUMN
    )

    description: Mapped[str] = mapped_column(
        Text, nullable=False, name=TaskDatabaseConstants.DESCRIPTION_COLUMN
    )

    user_id: Mapped[int] = mapped_column(
        Integer, nullable=False, name=TaskDatabaseConstants.USER_ID_COLUMN
    )

    status: Mapped[str] = mapped_column(
        String(20), nullable=False, name=TaskDatabaseConstants.STATUS_COLUMN
    )

    priority: Mapped[str] = mapped_column(
        String(10), nullable=False, default=TaskPriorityEnum.MEDIUM.value
    )

    # Timestamp fields
    created_at: Mapped[datetime] = mapped_column(
        DateTime, nullable=False, name=TaskDatabaseConstants.CREATED_AT_COLUMN
    )

    completed_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime, nullable=True, name=TaskDatabaseConstants.COMPLETED_AT_COLUMN
    )

    updated_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime, nullable=True, name=TaskDatabaseConstants.UPDATED_AT_COLUMN
    )
...
class TaskRepository(TaskGateway):
    ...
    def find_task_by_id(self, task_id: UUID) -> Optional[TaskEntity]:
        ...
        try:
            ...
            if model is None:
                logger.debug("Task not found", extra={"task_id": str(task_id)})
                return None
    ...
    def find_tasks_by_status(self, status: TaskStatusEnum) -> List[TaskEntity]:
        ...
        try:
            ...
            logger.debug(
                ...
                extra={"status": status.value, "task_count": len(tasks)},
            )
    ...
    def count_tasks_by_user(self, user_id: int) -> int:
        ...
        try:
            active_statuses = [
                status.value for status in TaskStatusEnum.get_active_statuses()
            ]
            ...
            logger.debug(
                ...
                extra={"user_id": user_id, "active_task_count": count},
            )
