...
class MockEventListener:
    ...
    def handle_user_status_change(self, user_id: int, old_status: UserStatusEnum, new_status: UserStatusEnum) -> None:
        """
        ...
        self.events_received.append(event)
        print(f"Mock Event: User {user_id} status changed from {old_status.value} to {new_status.value}")
