...
class DatabaseConnection:
    ...
    def _initialize_engine(self) -> None:
        ...
        try:
            ...
            self._engine = create_engine(
                ...
                echo_pool=self._config.echo if settings.application.is_development else False,
            ...
            logger.error(
                ...
                extra={"error": str(e), "database_url_masked": self._config.connection_url_masked}
            )
            raise
    ...
    def _configure_session(self, session: Session) -> None:
        ...
        try:
            ...
            session.execute(
                text(f"SET SESSION innodb_lock_wait_timeout = {TransactionConstants.DEFAULT_TIMEOUT}")
            )
            ...
            logger.warning(
                "Failed to configure session settings",
                extra={"error": str(e)}
            )
