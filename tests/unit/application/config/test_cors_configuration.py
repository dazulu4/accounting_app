...
class TestCORSConfiguration:
    ...
    def test_production_cors_accepts_valid_https_origins(self):
        ...
        config = APIConfig(cors_origins=["https://app.company.com", "https://admin.company.com"])
        assert config.cors_origins == ["https://app.company.com", "https://admin.company.com"]
...
class TestCORSEnvironmentSpecific:
    ...
    def test_production_environment_cors_strict(self):
        ...
        assert config.api.cors_origins == ["https://app.company.com", "https://admin.company.com"]
